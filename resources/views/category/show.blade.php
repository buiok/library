...
@section('content')
    <div class="container">
        <h1 class="my-md-5 my-4">Материалы в категории {{ $category->name }}</h1>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="text-nowrap text-end">
                        ...
                        <form style='display:inline;' action="{{ route('materials.destroy', $material->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button  style='color: #0d6efd;border:0;background:none' type="submit" onclick="return confirm('Вы уверены, что хотите удалить материал?')">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
